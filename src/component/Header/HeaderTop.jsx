        ...
        <Box sx={{ background: '#1F4E3D', }}>
            <Container fixed sx={{ justifyContent: 'center', textAlign:{sm:'left', xs:'center'}, display: 'flex' }}>
                ...
                >
                    ...
                    <Box py={2}>
                        <Image src='/images/logo.png' width={170} height={52} priority={true} alt='Web Logo'></Image>
                    </Box>

                    <Box py={2} display={'flex'} gap={1} sx={{justifyContent:'center'}}>
                        <Image src='/images/Symbol.png' priority={true} width={45} height={40} alt="Picture of the author"></Image>
                        <Box>
