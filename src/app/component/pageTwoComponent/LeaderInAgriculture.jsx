            ...
            <Box >
                <Container fixed>
                    <Grid container spacing={8}>
                        ...
                        <Grid size={{ md: 6 }}>
                            <Item>
                                    <Box sx={{display:'flex', justifyContent:'space-between', gap:{lg:0 , xs:'10px'}}}>
                                        <Box sx={{display:'flex', justifyContent:'space-between',
                                            flexDirection:'column'
                                        }}>
                                        <Box sx={{width:{lg:'230px', md:'160px'}, height:'225px'}}>
                                            <Image src={section2Img1} style={{width:'100%', height:'100%'}} alt='section2Img1'></Image>
                                        </Box>
                                        <Box sx={{width:{lg:'230px', md:'160px'}, height:'125px'}}>
