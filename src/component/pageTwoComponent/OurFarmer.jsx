...
import Farmer1 from '../../../public/images/OurFarmers.png';
import Farmer2 from '../../../public/images/OurFarmers1.png';
import Farmer3 from '../../../public/images/OurFarmers2.png';
  ...
  return (
    <Box sx={{padding:'80px 0px'}}>
        <Container fixed>
            ...
            <Grid container spacing={3} sx={{ justifyContent:{md:'space-between', xs:"center"}, gap:{md:0, sm:3}}}>
                {OurFarmers.map((farmer)=>{
                    return(
                        <Grid size={{md:4, sm:6}} sx={{marginBottom:{lg:"40px", xs:'50px'}}} key={farmer.id}>
                    <Item>
                        <Box sx={{position:'relative', width:{md:'87%', xs:'100%'}}}>
                            <Image src={farmer.img} alt="Farmer" style={{borderRadius:'6px',width:'100%'}}></Image>
                            <Box sx={{textAlign:'end', background:'#FFFFFF',borderRadius:'6px', boxShadow: 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px', padding:'22px 60px', position:'absolute', bottom:'-40px', right:{lg:'-45px', md:'8px',sm:"23px", xs:'58px'}}}>
